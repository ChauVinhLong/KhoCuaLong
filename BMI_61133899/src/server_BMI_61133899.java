...
public class server_BMI_61133899 {
	...
	public static void main(String[] args) {
		try {
			...
			{	
			    ...
			    int CanNang= Integer.parseInt(chuoiCanNang);
			    int ChieuCao=Integer.parseInt(chuoiChieuCao);
			    float BMI=CanNang/(ChieuCao*ChieuCao);
			    
			    String chuoiKQ_Gui;
				if(BMI<18.5)
			    {
			    	chuoiKQ_Gui = "Bạn bị thiếu cân";
			    	if(BMI>=18.5 && BMI<=24.9)
			    		chuoiKQ_Gui = "Bạn bình thường";
			    }
			    else
			    	chuoiKQ_Gui = "Bạn bị thừa cân";
